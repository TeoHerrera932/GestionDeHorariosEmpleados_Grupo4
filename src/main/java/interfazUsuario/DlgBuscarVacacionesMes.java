...
public class DlgBuscarVacacionesMes extends JDialog {
    ...
    public DlgBuscarVacacionesMes(JFrame parent, Control control) {
        super(parent, "Vacaciones por Mes", true);
    ...
    private void initUI() {
        ...
        modeloTabla = new DefaultTableModel(new String[]{"Código Empleado", "Inicio", "Fin", "Estado"}, 0);
    ...
    private void buscar() {
        try {
            ...
            ArrayList<Vacacion> vacaciones = control.consultaVacacionesPorMes(mes, anio);
